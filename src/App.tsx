...
const WORD_BANK: Word[] = [
  ...
  { base: "eat", past: "ate", participle: "eaten", icon: "🍎", stage: 0 },
  ...
  { base: "see", past: "saw", participle: "seen", icon: "👁️", stage: 0 },
  { base: "come", past: "came", participle: "come", icon: "🚶", stage: 0 },
  { base: "go", past: "went", participle: "gone", icon: "🏃", stage: 0 },
  { base: "get", past: "got", participle: "gotten", icon: "📦", stage: 0 },
  { base: "buy", past: "bought", participle: "bought", icon: "🛍️", stage: 0 },
  { base: "bring", past: "brought", participle: "brought", icon: "🚚", stage: 0 },
  { base: "catch", past: "caught", participle: "caught", icon: "🎣", stage: 0 },
  { base: "draw", past: "drew", participle: "drawn", icon: "🎨", stage: 0 },
  ...
  { base: "hide", past: "hid", participle: "hidden", icon: "🙈", stage: 0 },
  { base: "keep", past: "kept", participle: "kept", icon: "🗝️", stage: 0 },
];
